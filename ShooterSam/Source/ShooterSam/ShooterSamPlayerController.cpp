...
void AShooterSamPlayerController::BeginPlay()
{
	...
	if (HUDWidget)
	{
		...
		HUDWidget->SetMessageText("Mission: Eliminate all enemies");
		HUDWidget->MessageTextBlock->SetVisibility(ESlateVisibility::Visible);
...
void AShooterSamPlayerController::OnCountdownTimerTimeout()
{
	HUDWidget->MessageTextBlock->SetVisibility(ESlateVisibility::Hidden);
}
